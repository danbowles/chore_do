defmodule ChoreDoWeb.MemberLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :members, Households.list_members())}
  end
  ...
  @impl true
  def handle_info({ChoreDoWeb.MemberLive.FormComponent, {:saved, member}}, socket) do
    {:noreply, stream_insert(socket, :members, member)}
  end

  @impl true
  def handle_event("delete", %{"id" => id}, socket) do
    member = Households.get_member!(id)
    {:ok, _} = Households.delete_member(member)
