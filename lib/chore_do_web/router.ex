defmodule ChoreDoWeb.Router do
  use ChoreDoWeb, :router

  import ChoreDoWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ChoreDoWeb.Layouts, :root}
  ...
  if Application.compile_env(:chore_do, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ChoreDoWeb.Telemetry
